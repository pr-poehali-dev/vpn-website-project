...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Серверы в десятках стран. Выберите любую точку планеты в один клик.",
    accent: "#7c3aed",
  },
  {
    icon: "Eye",
...
const PLANS = [
  ...
  },
  {
    ...
    price: "399",
    period: "мес",
    features: ["10 устройств", "Все страны", "1 Гбит/с", "AES-256", "Нулевые логи", "Приоритет поддержки"],
    popular: true,
    cta: "Выбрать Про",
  },
  {
    ...
    price: "999",
    period: "мес",
    features: ["Безлимит устройств", "Все страны", "10 Гбит/с", "Выделенный IP", "API доступ", "SLA 99.9%"],
    popular: false,
    cta: "Связаться",
  },
];
